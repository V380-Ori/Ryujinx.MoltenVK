...
MVK_PUBLIC_VULKAN_SYMBOL void vkCmdPushConstants2(
	...
	MVKTraceVulkanCallStart();
	MVKAddCmd(PushConstants, commandBuffer, pPushConstantsInfo->layout, pPushConstantsInfo->stageFlags,
			pPushConstantsInfo->offset, pPushConstantsInfo->size, pPushConstantsInfo->pValues);
	MVKTraceVulkanCallEnd();
}
